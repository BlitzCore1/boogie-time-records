...
public class CategoriesController
{
    ...
    @PreAuthorize("permitAll")
    public Optional<Category> getById(@PathVariable int categoryId)
    {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<Object> updateCategory(@PathVariable int categoryId, @RequestBody Category category)
    {
        // update the category by id and return the updated category (200 OK)
        var categoryToUpdate = categoryService.getCategoryById(categoryId);
